...
#define LINE_BUTTON                 PAL_LINE(GPIOB, BUTTON)
...
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_PULLUP(TIM3_CH3_LEDSTRING3) |       \
                                     ...
                                     PIN_PUPDR_FLOATING(MODEM_IO0_RESET) |        \
