...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin : LED_GREN_Pin */
  GPIO_InitStruct.Pin = LED_GREN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(LED_GREN_GPIO_Port, &GPIO_InitStruct);
...
void task_1_function(void *argument)
{
  ...
  for(;;)
  {
      HAL_GPIO_TogglePin(LED_GREN_GPIO_Port, LED_GREN_Pin);
    osDelay(1000);
  }
  /* USER CODE END 5 */
}
