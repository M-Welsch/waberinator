...
#define UNDERVOLTAGE_THRESHOLD 450 //orig. 594: 100k and 33k => Vbat,min = 11.8V
#define OVERTEMPERATURE_THRESHOLD 850 //21760 //about 85°C
...
int main(void){
	...
	while(1){
		...
		if(mainloop_counter2 == time_to_wait_ms) {
			...
			time_to_wait_ms = 8 + 5*waberung_frequency/(waberung_depth+1);
			mainloop_counter2 = 0;
		}
